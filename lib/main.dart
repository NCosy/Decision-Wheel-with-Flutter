    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            SpinningWheel(
              Image.asset('images/roulette-8-300.png'),
              width: 310,
              height: 310,
              initialSpinAngle: _generateRandomAngle(),
              spinResistance: 0.6,
              ...
              onEnd: _dividerController.add,
              secondaryImage:
              Image.asset('images/roulette-center-300.png'),
...
// import 'package:flutter/material.dart';
// import 'wheelcode.dart';
//
// void main() => runApp(SpinWheel());
//
...
//       home: Scaffold(
//         appBar: AppBar(
//           title: Text("HANGİ GÜN YAPMALIYIM ?"),
//           centerTitle: true,
//         ),
//         body: Wheel(),
//       ),
